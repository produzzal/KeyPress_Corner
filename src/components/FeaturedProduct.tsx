...
const FeaturedProduct = () => {
  ...
  return (
    <div className="my-20 mx-2">
      ...
      <Link
        to="/products"
        className="flex mx-auto justify-center items-center w-44 mt-4 bg-[#BBBAF8] px-6 py-2 rounded transition-colors hover:bg-[#9c9af6]"
      >
        <button className="mr-1">See More</button>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
